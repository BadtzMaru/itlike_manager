		...
		return (
			...
			>
				<Form
					{...formItemLayout}
					onFinish={onFinish}
					ref={this.lifejobFormRef}
				>
					<Item
						label={'人生名称'}
						name={'job_name'}
						rules={[
							{ required: true, message: '请输入职场人生名称' },
						]}
					>
						<Input />
					</Item>
					<Item
						...
						name={'job_author'}
						rules={[
							{ required: true, message: '请输入职场人生作者' },
						]}
					>
						<Input />
					</Item>
					<Item
						...
						name={'job_pre_edu_id'}
						rules={[
							{ required: true, message: '请选择学前所属分类' },
						]}
					>
						<Select
							style={{ width: 200 }}
					...
					<Item
						...
						rules={[
							{ required: true, message: '请选择所属家园分类' },
						]}
					>
						<Select
							style={{ width: 200 }}
